...
void main() {
  runApp(MainApp6());  // Inicia la aplicación ejecutando el widget MyApp.
}
...
class _MessageListScreenState extends State<MessageListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Scroll infinit"),  // Título de la barra de la aplicación.
        actions: [
          // Icono de búsqueda en la parte derecha de la barra de la aplicación.
          IconButton(
            icon: Icon(Icons.search),
            onPressed: () {}, // Funcionalidad vacía para el botón de búsqueda por ahora.
          ),
        ],
      ),
      ...
      bottomNavigationBar: BottomAppBar(
        shape: CircularNotchedRectangle(),  // Da forma redondeada a la parte central de la barra.
        notchMargin: 6.0,  // Margen para la muesca donde va el botón flotante.
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,  // Espaciado entre los iconos.
          children: [
            // Icono de inicio.
            IconButton(
              icon: Icon(Icons.home),
              onPressed: () {}, // Funcionalidad vacía para el botón de inicio por ahora.
            ),
            // Icono de mensajes.
            IconButton(
              icon: Icon(Icons.message),
              onPressed: () {}, // Funcionalidad vacía para el botón de mensajes por ahora.
            ),
          ],
        ),
      ),
      // Ubicación del botón flotante en la parte central de la barra inferior.
